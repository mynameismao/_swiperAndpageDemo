  ...
  mounted () {
    Vue.nextTick(() => {
      var swiper = new Swiper ('#swiper_all', {
        initialSlide: this.$route.path === '/home/tabs=1' ? 0 : this.$route.path === '/home/tabs=2' ? 1 : this.$route.path === '/home/tabs=3' ? 2 : this.$route.path === '/home/tabs=4' ? 3 : this.$route.path === '/home/tabs=5' ? 4 : this.$route.path === '/home/tabs=6' ? 5 : this.$route.path === '/home/tabs=7' ? 6 : this.$route.path === '/home/tabs=8' ? 7 : 0
      })
